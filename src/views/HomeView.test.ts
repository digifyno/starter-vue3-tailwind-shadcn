...
describe('HomeView', () => {
  ...
  it('has no axe violations', async () => {
    const wrapper = mount(HomeView)
    // HomeView is always rendered inside <main id="main-content"> in App.vue.
    // Disable the region rule which requires content to be in a landmark —
    // that landmark is provided by the parent App shell, not this view component.
